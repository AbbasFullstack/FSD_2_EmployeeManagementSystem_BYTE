...
async function seed() {
  if (!process.env.MONGODB_URI) {
    throw new Error("MONGODB_URI must be configured before running the seed script.");
  }

  await mongoose.connect(process.env.MONGODB_URI);

  // The seed is intentionally deterministic: it resets the configured database.
  ...
  console.log("Created 5 sample employees and 3 sample audit logs.");
}
